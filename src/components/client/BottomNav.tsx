...
export function BottomNav({ onCheckinClick }: { onCheckinClick?: () => void }) {
  ...
  return (
    <nav className="fixed bottom-0 inset-x-0 z-30">
      <div className="mx-auto max-w-md bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg border border-white/30">
              ...
              <li key={item.view}>
                {isCheckin && onCheckinClick ? (
                  <button
                    ...
                    className="w-full flex flex-col items-center justify-center py-3 text-xs focus:outline-none"
