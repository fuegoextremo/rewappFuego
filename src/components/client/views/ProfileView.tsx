    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <UserCircle
            className="w-16 h-16 text-gray-300 mx-auto mb-4 antialiased"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(180deg, ${primaryColor} 0%, #FFF 100%)`,
        }}
      />
      ...
      >
        <div className="max-w-md mx-auto px-6 py-12 text-center">
          ...
          <div className="space-y-2">
            ...
            {user.phone && (
              <p className="opacity-90 flex items-center justify-center">
                <Phone
                  className="w-4 h-4 mr-2  antialiased"
                  style={{ shapeRendering: "geometricPrecision" }}
                />{" "}
                {user.phone}
              </p>
            ...
            {extendedData.data?.birth_date && (
              <p className="opacity-90 flex items-center justify-center">
                <Cake
                  ...
                  style={{ shapeRendering: "geometricPrecision" }}
                />{" "}
                {formatDate(extendedData.data.birth_date)}
              </p>
            )}
            <p className="text-sm opacity-80">
              {user.role === "client" ? "Cliente" : user.role || "Usuario"}{" "}
              desde {formatJoinYear(extendedData.data?.created_at || null)}
            </p>
          </div>
        </div>
      </motion.div>
        ...
        >
          ...
          >
            <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
              <Lock
                className="w-5 h-5 text-blue-600 antialiased"
                style={{ shapeRendering: "geometricPrecision" }}
              />
            </div>
          ...
          >
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
              <LogOut
                className="w-5 h-5 text-gray-600 antialiased"
                style={{ shapeRendering: "geometricPrecision" }}
              />
            </div>
            <div className="flex-1 text-left">
        ...
        >
          ...
          >
            <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center">
              <AlertTriangle
                className="w-5 h-5 text-red-600 antialiased"
                style={{ shapeRendering: "geometricPrecision" }}
              />
            </div>
            <div className="flex-1 text-left">
              ...
              <p className="text-sm text-red-600">
                Desactivar permanentemente tu cuenta
              </p>
            </div>
          </button>
        </motion.div>
      ...
      >
        <div className="relative overflow-hidden">
          ...
          <div className="relative p-6">
            ...
            <ChangePasswordForm onCancel={() => setActiveSheet(null)} />
          </div>
        </div>
      </BottomSheet>
      ...
      >
        <div className="p-6 space-y-4">
          <div className="">
            ...
            <AlertTriangle
              className="w-6 h-6 text-red-600 flex-shrink-0 mt-0.5 antialiased"
              style={{ shapeRendering: "geometricPrecision" }}
            />
            ...
            <div className="flex-1">
              ...
              <p className="text-red-700 text-sm mb-4">
                Esta acción eliminará tu cuenta de forma permanente. No es posible deshacer esta acción.
              </p>
